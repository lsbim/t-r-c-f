...
const IndexPage = () => {
  ...
  return (
    <div>
      <HeaderNav />
      <ConvertJsonComponent session={session} setDebugInfo={setDebugInfo} debugInfo={debugInfo} />
